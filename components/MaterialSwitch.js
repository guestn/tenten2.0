...
export default class MaterialSwitch extends Component {
	...
	static defaultProps = {
      active: false,
      styles: {},
      inactiveButtonColor: '#4ca2cd',
      inactiveButtonPressedColor: '#4ca2cd',
      activeButtonColor: '#67B26F',
      activeButtonPressedColor: '#67B26F',
      buttonShadow: {
        shadowColor: '#000',
        shadowOpacity: 0.2,
        shadowRadius: 5,
      ...
      <View style={{padding: this.padding, position: 'relative'}}>
        ...
        <TouchableHighlight underlayColor='transparent' activeOpacity={1} onPress={() => { this.toggle(); }} style={{
          ...
          <Animated.View style={[{
              ...
              position: 'absolute',
              top: this.props.switchHeight/2 - this.props.buttonRadius,
              left: this.props.switchHeight/2 > this.props.buttonRadius ? halfPadding : this.props.switchHeight/2 - this.props.buttonRadius,
